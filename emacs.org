...
A "next-generation, purely functional package manager for the Emacs hacker"; for my purposes, allows for the ~:straight~ keyword to be used in, e.g., ~org-roam~.

Documentation [[https://github.com/raxod502/straight.el][here]].
...
#+BEGIN_SRC emacs-lisp
  (set-register ?c (cons 'file "~/org/notebooks/notebook.org"))
  ...
  (set-register ?w (cons 'file "~/org/hub/waterford.org"))
#+END_SRC
...
I'm trying out [[https://github.com/jethrokuan/org-roam][org-roam]] as a way of organizing some of my notebooks. It's based on the Roam note-taking ecosystem, about which I know little. But this rudimentary implementation looks cool.

I had to install some boilerplate in the package management in order to use the ~:straight~ keyword.
