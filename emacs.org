...
#+BEGIN_SRC emacs-lisp
  ...
  (set-register ?r (cons 'file "~/org/hub/records/"))
...
Write a function here that pulls together certain packages?

*** Functions to Switch Among Themes

#+BEGIN_SRC emacs-lisp
  (setq owl/themes '(flatland moe-dark poet poet-dark leuven cyberpunk))
...
#+BEGIN_SRC emacs-lisp
  (use-package org-books
    ...
    (use-package enlive)
    :config (setq org-books-file "~/org/notebooks/reading.org"))
#+END_SRC
