...
- [[#configuration][Configuration]]
  ...
  - [[#writing-environment][Writing Environment]]
    - [[#automatically-resize-images][Automatically Resize Images]]
...
**** COMMENT I currently leave it untangled because I'm not using it. It is here like the man with the vulture eye, a burning, itching reminder.
