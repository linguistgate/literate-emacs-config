...
- [[#configuration][Configuration]]
  ...
  - [[#publishing-management][Publishing Management]]
    - [[#preprocessing-hooks][Preprocessing Hooks]]
      - [[#backlinks-and-contents][Backlinks and Contents]]
...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  (set-face-attribute 'variable-pitch nil :font "Input Serif")
  (set-face-attribute 'fixed-pitch nil :font "Input Mono")
...
#+BEGIN_SRC emacs-lisp
  (setq owl/themes '(leuven zenburn))
...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    ...
    (org-roam-graph-exclude-matcher '("sitemap"))
...
#+begin_src emacs-lisp :tangle yes
  (defun owl/org-roam--backlinks-list-with-content (file)
    (with-temp-buffer
  ...
  (defun owl/org-export-preprocessor (backend)
    (let ((links (owl/org-roam--backlinks-list-with-content (buffer-file-name))))
      (unless (string= links "")
        (save-excursion
          (goto-char (point-max))
          (insert (concat "\n* Backlinks\n") links)))))

  (add-hook 'org-export-before-processing-hook 'owl/org-export-preprocessor)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-publish-project-alist
        '(
          ...
          ("org-notebooks-content"
           :base-directory "~/org/notebooks/"
           :base-extension "org"
           :publishing-directory "~/private_html/org-notebooks/"
           :recursive t
          ...
          ("org-notebooks-static"
           :base-directory "~/org/notebooks/"
           :base-extension "css\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3\\|ogg\\|swf\\|eot\\|svg\\|ttf\\|woff"
           :publishing-directory "~/private_html/org-notebooks/"
           :recursive t
           :publishing-function org-publish-attachment
           )
          ("org-notebooks-dumps"
           :base-directory "~/org/notebooks/notes/static/dumps/"
           :base-extension "html"
           :publishing-directory "~/private_html/org-notebooks/notes/static/dumps/"
           :recursive t
           :publishing-function org-publish-attachment
           )
          ("org-areas-content"
           :base-directory "~/org/hub/"
           :base-extension "org"
           :publishing-directory "~/private_html/org-areas/"
           :recursive nil
           :publishing-function org-html-publish-to-html
           :headline-levels 4             ; Just the default for this project.
           :auto-preamble t
          ...
          ("org-notebooks" :components ("org-notebooks-content" "org-notebooks-static" "org-notebooks-dumps"))
          ("org-areas" :components ("org-areas-content" "org-areas-static"))))
#+end_src
